...
{typeof navigator !== 'undefined' && !navigator.onLine && error && (
        <div style={{
          ...
          color: '#ffffff',
          zIndex: 9999,
          boxShadow: '0 10px 40px rgba(255, 75, 87, 0.3)',
          maxWidth: '420px',
          textAlign: 'center',
          fontSize: '15px',
          fontWeight: 500,
          ...
          <div style={{ position: 'relative' }}>
            <button
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.background = 'linear-gradient(135deg, #ee5a6f 0%, #ff4757 100%)';
            ...
            <div style={{ padding: '8px 4px', fontWeight: '600' }}>
              ⚠️ {error}
            </div>
          </div>
        </div>
